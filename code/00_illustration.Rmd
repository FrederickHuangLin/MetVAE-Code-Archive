...
# saveRDS(boot_res, "../results/intermediate_results/illustrate_boot_sparcc_composit.rds")
boot_res = read_rds("../results/intermediate_results/illustrate_boot_sparcc_composit.rds")
...
# saveRDS(se_mb, "../results/intermediate_results/illustrate_se_composit.rds")
se_mb = read_rds("../results/intermediate_results/illustrate_se_composit.rds")
...
# saveRDS(boot_res, "../results/intermediate_results/illustrate_boot_sparcc_zero.rds")
boot_res = read_rds("../results/intermediate_results/illustrate_boot_sparcc_zero.rds")
p_res = pval.sparccboot(boot_res)
sparcc_p = diag(0, nrow = d, ncol = d)
sparcc_p[upper.tri(sparcc_p, diag = FALSE)] = p_res$pvals
sparcc_p = sparcc_p + t(sparcc_p)
...
#                    nlambda = 20, pulsar.params = list(rep.num = 50, ncores = 4))
# saveRDS(se_mb, "../results/intermediate_results/illustrate_se_zero.rds")
se_mb = read_rds("../results/intermediate_results/illustrate_se_zero.rds")
se_beta = as.matrix(symBeta(getOptBeta(se_mb), mode = "maxabs"))
...
# boot_res = sparccboot(data, R = 1000)
# saveRDS(boot_res, "../results/intermediate_results/illustrate_boot_sparcc_confound.rds")
boot_res = read_rds("../results/intermediate_results/illustrate_boot_sparcc_confound.rds")
p_res = pval.sparccboot(boot_res)
sparcc_p = diag(0, nrow = d, ncol = d)
sparcc_p[upper.tri(sparcc_p, diag = FALSE)] = p_res$pvals
sparcc_p = sparcc_p + t(sparcc_p)
...
# se_mb = spiec.easi(data, method = "mb", lambda.min.ratio = 1e-2,
#                    nlambda = 20, pulsar.params = list(rep.num = 50, ncores = 4))
# saveRDS(se_mb, "../results/intermediate_results/illustrate_se_confound.rds")
se_mb = read_rds("../results/intermediate_results/illustrate_se_confound.rds")
se_beta = as.matrix(symBeta(getOptBeta(se_mb), mode = "maxabs"))
rownames(se_beta) = colnames(data)
colnames(se_beta) = colnames(data)
...
ggsave(filename = "../results/figures/supp_motivate1.pdf", 
       plot = fig_motivate1, width = 12, height = 8)
ggsave(filename = "../results/figures/supp_motivate2.pdf", 
       plot = fig_motivate2, width = 9, height = 8)
ggsave(filename = "../results/figures/supp_motivate3.pdf", 
